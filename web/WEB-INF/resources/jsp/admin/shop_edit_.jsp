             ...
             <div class="row">
                <div class="col-sm-offset-8 col-lg-4">
                   <a class="btn btn-default  btn-block"
                      href="<spring:url value="/admin/shop_product/add" />">
                      <spring:message code="label.add.product"/></a>
                </div>
            <br/>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form container-fluid shop-edit" 
                                  action="<c:url  value="/admin/shops" />" modelattribute="shop"
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="submit" id="btn-shop-edit" class="btn btn-block" 
