             ...
             <div class="row">
                <div class="col-sm-offset-8 col-lg-4">
                   <a class="btn btn-default  btn-block"
                      href="<spring:url value="/admin/product/add" />">
        ...
        <tbody>
            <c:forEach items="${products}" var="product">
                <tr>
                    ...
                    <td>
                        <img src="<spring:url value="/resources/${product.mainImage}"/>" width="100"  height="100"/>
                    </td>
                    <td>${product.description}   </td>
                     <td>${product.brand}   </td>
                    <td>${product.dateCreation}    </td>
                    <td>
                        <a class="fa fa-save" title="${modification}" href="admin/save?id=${product.id}"></a>
                        <a  class="fa fa-cut" data-toggle="modal" data-target="#myModal"></a>
                         <a class="fa fa-eraser" title="${totaldeletion}"
                            href="product/delete?id=${product.id}"></a>
                             <!-- Modal -->
