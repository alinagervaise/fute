...
<!DOCTYPE html>
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><spring:message code="label.rayon"/>s</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form container-fluid rayon-add" 
                                  action="<c:url  value="/admin/rayons" />" modelattribute="rayon"
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                                            <div class="form-group col-xs-6">
                                                ...
                                                <form:input path="rayon.name" class="form-control" 
                                                            placeholder="${name}" />
                                                <form:errors path="rayon.name" cssclass="error"></form:errors>
                                            </div>
                                            <div class="form-group col-xs-6">
                                                <label><spring:message code="rayon.shortName"/></label>
                                                <spring:message code="label.shortname" var="shortname"/>
                                                <spring:message code="label.shortname.tooltip" var="shortname-tooltip"/>
                                                <form:input path="rayon.shortName"  class="form-control" 
                                    ...
                                    <div classs="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <form:textarea path="rayon.description"  class="form-control" 
                                                         rows="3"   placeholder="${description}" />
                                            <form:errors path="rayon.description" class="error"></form:errors>
                                        </div>
                                        <div class="form-group col-xs-12">
                                           <div class="form-group col-xs-6">
                                            ...
                                            <div class="form-group col-xs-6">
                                                ...
                                                <img id="img-rayon-id" src="_" width="100" height="100"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="submit" id="btn-rayon-add" class="btn btn-block" 
            ...
            function readURL(input) {
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function (e) {
                        $('#img-rayon-id').attr('src', e.target.result);
                    };
