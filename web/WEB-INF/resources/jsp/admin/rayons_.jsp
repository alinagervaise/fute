             ...
             <div class="row">
                <div class="col-sm-offset-8 col-lg-4">
                   <a class="btn btn-default  btn-block"
                      href="<spring:url value="/admin/rayons/add" />">
        ...
        <thead>
            <tr>
               <th> <spring:message code="user.id"/></th>
                ...
                <th> <spring:message code="label.short_name"/></th>
        ...
        <tbody>
            <c:forEach items="${rayons}" var="rayon">
                <tr>
                    <td>${rayon.id}          </td>
                    <td>${rayon.name}   </td>
                    <td>${rayon.shortName}    </td>
                    <td>${rayon.description}       </td>
                    <td>
                        <img src="<spring:url value="/resources/${rayon.path}"/>" width="100"  height="100"/>
                    </td>
                    <td>${rayon.dateCreation}    </td>
                    <td>
                        <a class="fa fa-save" title="${modification}" href="admin/save?id=${rayon.id}"></a>
                        <a  class="fa fa-cut" data-toggle="modal" data-target="#myModal"></a>
                         <a class="fa fa-eraser" title="${totaldeletion}"
                            href="rayon/delete?id=${rayon.id}"></a>
                             <!-- Modal -->
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                       <a href="rayon/delete?id=${rayon.id}">
