             ...
             <div class="row">
                <div class="col-sm-offset-8 col-lg-4">
                   <a class="btn btn-default  btn-block"
                      href="<spring:url value="/admin/shop/add" />">
        ...
        <tbody>
            <c:forEach items="${shops}" var="shop">
                <tr>
                    <td>${shop.id}          </td>
                    <td>
                        <img src="<spring:url value="/resources/${shop.logo}"/>" width="100"  height="100"/>
                    </td>
                    <td>${shop.name}   </td>
                    <td><c:out value="${shop.address.street};${shop.address.neighborhood} ; ${shop.address.city} ;${shop.address.country} "/> </td>
                  
                    
                    <td>
                        <a class="fa fa-edit" title="${modification}" href="shop/edit?id=${shop.id}"></a>
