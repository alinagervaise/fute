    ...
    <ul class="nav navbar ">
        ...
        <c:choose>
            <c:when test="${firstname != null }">
                <li class="dropdown header">
                    <a id="profil" href="<c:url value="/admin/index"/>" class="dropdown-toggle   header" data-toggle="dropdown"
            ...
            <c:otherwise>
                ...
                <li class=" header"><a href="<spring:url value="/connect" />"class="header"><spring:message code="visitor.connect"/>
